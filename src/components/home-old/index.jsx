...
export default class Home extends React.Component {
  ...
  render() {
    const matchJSX = this.state.matches.map((m) => {
      ...
      let isMatchFav = (m.displayTitle in Utils.getWatchLaterMatches());
      return ( <
        Match key = { m.displayTitle } loggedIn = { this.state.loggedIn } match = { m } title = { m.displayTitle } favorited = { isMatchFav } favoriteToggle = { this.favoriteToggle.bind(this) }
        />
      )
    });
    return ( <
